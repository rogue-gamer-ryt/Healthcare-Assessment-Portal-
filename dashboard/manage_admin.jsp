            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   <div class="push-s7 push-m10 push-l10 col s4 m3 l2">
                    <a href="create_admin.jsp" class="waves-effect waves-light btn">Add</a>
                  </div>
                   <div class="push-s7 push-m10 push-l6 col s4 m3 l2">
                    <a target="_blank" href="audittrials.jsp?str=Admin" class="waves-effect waves-light btn">Audit Trials</a>
                  </div>                   
                </div>
                <div class="row">
                        ...
                        <table class="centered striped">
							...
							<% 
							  try
								...
								connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
							    sql = "Select * from administrator where uid="+uid+" and hospitalID='"+hosid+"'";
								prs = connection.prepareStatement(sql);
								resultSet = prs.executeQuery();
								while(resultSet.next())
								{
								...
								int f=1;
								sql = "Select * from administrator where name!='"+name+"' and name!='"+creator+"' and creator='"+create+"'";
								prs = connection.prepareStatement(sql);
								resultSet = prs.executeQuery();								
								while(resultSet.next())
								{
							%>
                              <tr>
                                ...
                                <td id="stat"> <%=resultSet.getString("status") %></td>
                                <td> <%=resultSet.getString("creator") %></td>
                                <td> <%=resultSet.getString("createdate") %></td>
