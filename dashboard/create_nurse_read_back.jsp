      ...
      while (rowIterator.hasNext()) 
      {
         ...
         while ( cellIterator.hasNext()) 
         {
			...
			try
			{
				...
				String name="";
				if(str[4].equals("None"))
				{
					name=str[0]+" "+str[1]+" "+str[2]+" "+str[3];
				}
				else
				{
					name=str[0]+" "+str[1]+" "+str[2]+" "+str[3]+" "+str[4];	
				}
				if(name.equals("null null null null null")==false)
				{
				String sql="Insert into nurse_detail(id,hid,name,username,password,gender,creator) values ("+aid+","+hosid+",'"+name+"','"+str[5]+"','"+str[6]+"','"+str[7]+"','"+creator+"')";
