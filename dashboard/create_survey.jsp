        ...
        <div id="page-content-wrapper" style="padding-top: 20px;">
            <div class="container-fluid">
				...
				<div class="col s12 m6 push-l3">
				 <div class="row">
					<form class="col s12" method="POST" action="create_survey_back.jsp">
					  <div class="row">
						<div class="input-field col s6">
						  <input name="sname" id="dname" type="text" class="validate">
						  <label for="sname">Survey Name</label>
						</div>
					  </div>
					  <div class="row">
					  	<div class="input-field col s12">
					  	   <textarea id="surveydesc" name="surveydesc" class="materialize-textarea"></textarea>
