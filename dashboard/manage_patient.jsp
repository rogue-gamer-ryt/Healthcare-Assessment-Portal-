            ...
            <div class="container-fluid">
				...
				<div class="row">
                   <div class="push-s7 push-m10 push-l6 col s4 m3 l2">
                    <a target="_blank" href="audittrials.jsp?str=Patient" class="waves-effect waves-light btn">Audit Trials</a>
                  </div> 				
				</div>
                <div class="table">
                        ...
                        <table class="centered striped">
							...
							%>
                              <tr>
                                ...
                                <td><%=resultSet.getString("patient_detail.dob") %></td>
                                <td><%=resultSet.getString("patient_detail.gender") %></td>
                                <td><%=resultSet.getString("patient_detail.email") %></td>
                                <td><%=resultSet.getString("patient_detail.contact") %></td>
                                <td><%=resultSet.getString("patient_detail.address") %></td>
                                <td><%=resultSet.getString("nurse_detail.name") %></td>
                                <td><%=resultSet.getString("patient_detail.status") %></td>
								<td><a class="waves-effect waves-light btn red" onclick="setValue1(<%=resultSet.getString("patient_detail.pid") %>);scrollWin()" href="#modal1"> Reassign </a></td>
                                <td> <%=resultSet.getString("patient_detail.creator") %></td>
                                <td> <%=resultSet.getString("patient_detail.startdate") %></td>
                                <td width="8%"> <%=resultSet.getString("patient_detail.expirydate") %></td>
                              </tr>
							 <%
								}
								}
	...
	if(val==1)
		{
			...
			document.editForm.action="edit_admin.jsp";
			document.editForm.submit();
		}
	if(val==2)
		{
			document.toggleForm.action="POST";
			document.toggleForm.action="toggle_admin.jsp";
