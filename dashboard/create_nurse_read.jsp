...
%>
<head>
<meta http-equiv="refresh" content="0; url=create_nurse_read_back.jsp">
</head>
<%
   Long id =0L;
   ...
   if ((contentType.indexOf("multipart/form-data") >= 0)) {
      ...
      { 
         ...
         while ( i.hasNext () ) 
         {
			...
			System.out.println(request.getServletContext().getRealPath("")+ filePath + fileName.substring(fileName.lastIndexOf("\\")+1));
            RequestDispatcher rd = request.getRequestDispatcher("create_nurse_read_back.jsp");
