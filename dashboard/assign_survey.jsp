				...
				<div class="col s12 m6 push-l3">
				 ...
				 while(resultSet.next())
					 if(resultSet.getString("assigned")!=null)
						 survey=resultSet.getString("assigned");
				 %>
					<form class="col s12" method="POST" action="assign_survey_back.jsp">
					  <h5> Enter Illness Name(s)</h5>
					  <div class="row">
						<div class="input-field col s6">
						  <input name="sname" id="sname" value="<%=survey%>" type="text" class="validate">
