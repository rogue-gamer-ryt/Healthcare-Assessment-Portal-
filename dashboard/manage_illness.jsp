            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   <div class="push-s7 push-m10 push-l10 col s4 m3 l2">
                    <a href="create_illness.jsp" class="waves-effect waves-light btn">Add</a>
                  </div>
                   <div class="push-s7 push-m10 push-l6 col s4 m3 l2">
                    <a target="_blank" href="audittrials.jsp?str=Illness" class="waves-effect waves-light btn">Audit Trials</a>
                  </div>                   
                </div>
                <div class="row">
                        ...
                        <table class="highlight centered striped">
							...
							<% 
                              ...
                              <tr>
                                ...
                                <td><a href="edit_illness.jsp?id=<%=resultSet.getString("illnessID") %>" class="waves-effect waves-light btn red">Edit</a></td>
                                <td><a class="waves-effect waves-light btn red">Enable/Disable</a></td>
...
function confirmDelete(uname) {
    var test = confirm("Are you sure you want to delete this disease?");
    if(test==true)
        window.location = 'delete_illness.jsp?id='+uname;
        }
 </script>
