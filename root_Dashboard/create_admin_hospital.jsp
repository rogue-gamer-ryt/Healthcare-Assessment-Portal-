        ...
        <div id="page-content-wrapper" style="padding-top: 20px;">
            <div class="container-fluid">
				...
				<div class="col s12 m6 push-l3">
				 <div class="row">
					<form class="col s12" method="POST" action="create_admin_hospital_back.jsp">
					  <div class="row">
						<div class="input-field col s6">
						  <select name="hospital" id="hospital">
							<option value="" disabled selected>Select Hospital</option>
							<%
							String sql="Select * from root_hospital";
							...
							%>
							<option value=<%=resultSet.getString("hospitalID") %>><%=resultSet.getString("name") %></option>
							<%
							}
							%>
						</select>
