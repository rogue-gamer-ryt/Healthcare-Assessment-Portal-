            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   <div class="push-s7 push-m10 push-l10 col s4 m3 l2">
                    <a href="create_admin_hospital.jsp" class="waves-effect waves-light btn">Add</a>
                  </div>
                   <div class="push-s7 push-m10 push-l6 col s4 m3 l2">
                    <a target="_blank" href="audittrials.jsp?str=AdminHospital" class="waves-effect waves-light btn">Audit Trials</a>
                  </div>
                </div>
                <div class="row">
                        ...
                        <table class="centered striped">
							...
							<% 
							  try
							    ...
							    String sql = "Select root_hosadmin.*,root_hospital.* from root_hosadmin INNER JOIN root_hospital ON root_hospital.hospitalID=root_hosadmin.hospitalID ";
							...
							%>
                              <tr>
                                <td><%=f++ %></td>
                                <td><%=resultSet.getString("root_hosadmin.name") %></td>
                                <td><%=resultSet.getString("root_hosadmin.username") %></td>
                                <td><%=resultSet.getString("root_hospital.name") %></td>
								<td><a class="waves-effect waves-light btn red"   onclick="setValue1(<%=resultSet.getString("uid") %>)" href="#modal1"> Edit </a></td>
                                <td><a class="waves-effect waves-light btn red"   onclick="setValue2(<%=resultSet.getString("uid") %>)" href="#modal2"> Enable/Disable</a></td>
                                <td> <%=resultSet.getString("root_hosadmin.status") %></td>
                                <td> <%=resultSet.getString("root_hosadmin.creator") %></td>
                                <td> <%=resultSet.getString("root_hosadmin.startdate") %></td>
                                <td> <%=resultSet.getString("root_hosadmin.expirydate") %></td>
                              </tr>
							 <%
								}
								}
	...
	if(val==1)
		{
			...
			document.editForm.action="edit_admin_hospital.jsp";
			document.editForm.submit();
		}
	if(val==2)
		{
			document.toggleForm.action="POST";
			document.toggleForm.action="toggle_admin_hospital.jsp";
