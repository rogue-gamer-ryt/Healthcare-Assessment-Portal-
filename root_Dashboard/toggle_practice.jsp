...
{ 
	...
	sql="Select status from root_practice where practiceID="+userid;
	prs=connection.prepareStatement(sql);
	resultSet=prs.executeQuery();
	String pname="";
	while(resultSet.next())
	...
	sql = "Update root_practice set status='"+status+"' where practiceID="+userid;
	prs = connection.prepareStatement(sql);
	prs.executeUpdate();
    String action=status+" ";
    action=action.concat(pname);
