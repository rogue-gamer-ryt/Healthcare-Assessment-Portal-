            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   <div class="push-s7 push-m10 push-l10 col s4 m3 l2">
                    <a href="create_admin_root.jsp" class="waves-effect waves-light btn">Add</a>
                  </div>
                   <div class="push-s7 push-m10 push-l6 col s4 m3 l2">
                    <a target="_blank" href="audittrials.jsp?str=AdminRoot" class="waves-effect waves-light btn">Audit Trials</a>
                  </div>                  
                </div>
                <div class="row">
                ...
                int f=1;
                sql = "Select * from root_admin where name!='"+name+"' and name!='"+creator+"' and creator='"+create+"'";
                prs = connection.prepareStatement(sql);
                resultSet = prs.executeQuery();               
                while(resultSet.next())
                {
	...
	if(val==1)
		{
			...
			document.editForm.action="edit_admin_root.jsp";
			document.editForm.submit();
		}
	if(val==2)
		{
			document.toggleForm.action="POST";
			document.toggleForm.action="toggle_admin_root.jsp";
